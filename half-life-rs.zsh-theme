# Custom version of https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/half-life.zsh-theme
...
setopt prompt_subst
PROMPT="[%{$fg[blue]%}%D %*%{$reset_color%}] ${purple}%n%{$reset_color%} in ${limegreen}%~%{$reset_color%}\$(virtualenv_prompt_info)\$(ruby_prompt_info)\$vcs_info_msg_0_${orange} λ%{$reset_color%} "
